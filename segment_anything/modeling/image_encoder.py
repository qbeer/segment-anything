...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        Args:
            ...
            use_adapter (bool): If True, add adapter layer is added to each block.
        """
        super().__init__()
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            use_adapter (bool): If True, add adapter layer after the attention block.
        """
        super().__init__()
